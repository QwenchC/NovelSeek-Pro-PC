...
NovelSeek Pro PC 是一款面向中文长篇小说创作的桌面工具，覆盖从大纲规划、章节生成、插图封面、到电子书导出的完整流程。  
...
### 2. AI 能力
- DeepSeek：大纲、章节、润色、提示词
- Pollinations：章节推文图、段落插图、全书封面
- 插图支持锚点定位、预览、移动、删除
...
- 支持暗色/亮色模式一键切换
- 设置页 API 密钥输入支持显示/隐藏
- 设置页提供密钥获取链接（DeepSeek / Pollinations）
